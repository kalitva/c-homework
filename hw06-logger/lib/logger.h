...
#define log_debug(logger, message) (_log_internal(logger, DEBUG, message, __func__, __LINE__))
#define log_info(logger, message) (_log_internal(logger, INFO, message, __func__, __LINE__))
#define log_warn(logger, message) (_log_internal(logger, WARN, message, __func__, __LINE__))
#define log_error(logger, message) (_log_internal(logger, ERROR, message, __func__, __LINE__))
